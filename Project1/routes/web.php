...
// 選択したプレイリストの内訳
Route::get('/Playlist/{id}',[MusicFormController::class,'playlist']);

// プレイリストの削除の確認
Route::get('/Playlist/delete/{id}',[MusicFormController::class, 'playlistDelete']);
//削除の実行
Route::post('/Playlist/delete/{id}',[MusicFormController::class, 'playlistDeleteExec']);

// プレイリスト自体の追加
Route::get('/PlaylistAdd',[MusicFormController::class, 'playlistAdd']);
// 実行
Route::post('/PlaylistAdd',[MusicFormController::class, 'playlistAddExec']);
// 検索画面
